...
public class EnglishLemmaAnalyzer extends Analyzer implements Serializable{
	/**
	 * 
	 */
	...
	public static String[] MY_STOP_SET={"retweet","tweet","twitter", "?","please",
 	...
 	transient private GenericObjectPool<MyPosTagger> posTaggerPool;
 	 public EnglishLemmaAnalyzer() {
 		// TODO Auto-generated constructor stub
 		 this.posTaggerPool = new GenericObjectPool<MyPosTagger>(
 					new PosTaggerFactory());
 			this.posTaggerPool.setMaxIdle(50);
 	}
 	@Override
 	public TokenStreamComponents createComponents(String fieldName  ) {
 		
  		final Tokenizer src;
  			MyPosTagger tagger = null;
			try {
				tagger = this.posTaggerPool.borrowObject();
			} catch (Exception e) {
		  ...
		  this.posTaggerPool.returnObject(tagger);
