...
object Main extends App{
  ...
  val numRows              = Try(args(1)).getOrElse("10")
  val numBands             = Try(args(2)).getOrElse("20")
  val minDate=DateTime.parse(Try(args(3)).getOrElse("2012-11-05T02:00:00.000+01:00"))
  val maxDate=DateTime.parse(Try(args(4)).getOrElse("2012-11-05T08:00:00.000+01:00"))
